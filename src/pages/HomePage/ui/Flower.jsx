    ...
    return (
        ...
        >
            ...
            <div className="z-20 relative w-full flex flex-col items-center justify-center lg:px-0 px-3">
                <p className="font-unbounded font-semibold text-center lg:text-[30px] text-[25px] mt-20">
                ...
                <div className="md:w-[500px] backdrop-blur-lg bg-white/20 flex flex-row sm:gap-20 gap-12 sm:p-12 p-12 py-10 items-center justify-center mt-4 rounded-2xl ">
                    <p className="font-unbounded lg:text-[30px] text-[20px] whitespace-nowrap">3990 ₽</p>
                    <p className="font-unbounded lg:text-[30px] text-[20px] line-through whitespace-nowrap">7980 ₽</p>
                </div>
