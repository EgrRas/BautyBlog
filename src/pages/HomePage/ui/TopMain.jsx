...
const TopMain = () => {
    ...
    return (
        <div className="w-full lg:h-auto min-h-screen relative bg-white">
            ...
            <img
                className="absolute top-[400px] w-full md:h-[500px] sm:h-[460px] h-[400px] lg:hidden object-cover"
                src="/photos/main/TopBlur.svg"
                alt=""
                style={{
                    WebkitMaskImage: 'linear-gradient(to bottom, rgba(0,0,0,0), rgba(0,0,0,1) 10px)',
                    maskImage: 'linear-gradient(to bottom, rgba(0,0,0,0), rgba(0,0,0,1) 10px)',
            ...
            />
            <img
                className="lg:hidden absolute md:top-[790px] sm:top-[740px] top-[680px] w-full h-[140px] object-cover"
            ...
            <div className="absolute z-10 lg:top-36 top-[400px] lg:left-[20%] lg:w-[250px] w-full lg:text-left text-center lg:p-0 p-8">
                ...
                <div className="lg:hidden mx-auto mt-24 md:mt-10 top-[85%] font-unbounded w-[240px] h-[50px] flex items-center justify-center rounded-full border border-[#ffffff] backdrop-blur-xl text-[#1B3C4D] bg-white/40 uppercase text-[12px] font-light cursor-pointer hover:shadow-xl transition duration-200" onClick={() => nav("/Lk")}>
                    Узнай свой типаж
                </div>
            </div>
