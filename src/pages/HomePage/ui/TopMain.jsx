...
const TopMain = () => {
    ...
    return (
        <div className="w-full h-auto relative bg-white">
            ...
            <img className={`absolute z-20 left-0 transform ease-in-out duration-2000 ${isBouncing === true ? "top-[10%]" : "top-[5%]" }`} src="/photoes/main/Soplya.png" alt=""/>
            <img className={`absolute z-20 right-0 transform ease-in-out duration-2000 ${isBouncing === true ? "top-[0%]" : "-top-[5%]" }`} src="/photoes/main/Soplya3.png" alt=""/>
