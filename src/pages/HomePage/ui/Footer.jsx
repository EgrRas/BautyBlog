    ...
    return (
        <div className="relative w-full h-auto z-30">
            ...
            <div className="w-full lg:px-60 px-5 lg:py-20 pt-20 pb-5 flex lg:flex-row lg:justify-between flex-col gap-5 relative">
                ...
                <div className="flex flex-col lg:justify-between gap-5 lg:min-h-[250px]">
                    ...
                    <div className="flex flex-row items-center lg:justify-end justify-center gap-5 lg:my-0 my-5">
                        <a href={"https://t.me/mne_idet"}>
                            <img src="/photos/main/TG.svg" alt=""/>
                        </a>
                        <a href={"https://www.youtube.com/@mneidet"}>
            ...
            <div className="w-full lg:px-60 px-5 lg:pt-10 pb-20 flex lg:flex-row flex-col items-center justify-start lg:gap-16 gap-0 relative">
                <a className="font-montserrat text-[14px] font-light underline cursor-pointer" href={"https://mneidet.com/privacy/"}>Условия использования</a>
                <a className="font-montserrat text-[14px] font-light underline cursor-pointer" href={"https://mneidet.com/privacy/"}>Политика конфиденциальности</a>
